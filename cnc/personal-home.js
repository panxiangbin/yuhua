...
(function () {
  ...
  var COURSES = [
    {
      id: 'stage-1', title: '安全基础', file: 'course-safety-foundation.html',
      image: './assets/images/batch02_operation_basics/machine-init-flow-001.webp',
      alt: '数控机床开机、自检、回零与安全确认流程演示图',
      caption: '先确认急停、模式、门锁和回零状态，再进行受控操作。'
    },
    {
      id: 'stage-2', title: '认识加工中心', file: 'course-machining-center-basics.html',
      image: './assets/images/batch04_milling_tooling/milling-process-overview-001.webp',
      alt: '加工中心常见铣削工艺和机床工作区域演示图',
      caption: '认识主轴、工作台、刀库以及常见铣削工作区域。'
    },
    {
      id: 'stage-3', title: '坐标轴与运动方向', file: 'course-coordinate-axes.html',
      image: './assets/images/batch01_core/beginner-machine-zero-vs-work-zero-001.webp',
      alt: '机床参考点、工件零点与坐标方向关系演示图',
      caption: '用机床参考点和工件零点的关系理解 X、Y、Z 运动方向。'
    },
    {
      id: 'stage-4', title: '图纸、尺寸与基准', file: 'course-drawing-basics.html',
      image: './assets/images/batch01_core/measure-reading-set-001.webp',
      alt: '卡尺、千分尺和百分表对应图纸尺寸检测演示图',
      caption: '从尺寸、基准和量具对应关系入手读懂零件图。'
    },
    {
      id: 'stage-5', title: '机床坐标与工件坐标', file: 'course-machine-work-offset.html',
      image: './assets/images/batch05_alarm_drawing_material/dial-indicator-detail-001.webp',
      alt: '使用杠杆百分表找正工件和建立坐标基准的演示图',
      caption: '通过找正和偏置，把机床位置转换为工件坐标。'
    },
    {
      id: 'stage-6', title: '工件装夹基础', file: 'course-workholding-basics.html',
      image: './assets/images/batch04_milling_tooling/vise-clamping-basic-001.webp',
      alt: '平口钳、等高垫块和工件装夹找正演示图',
      caption: '定位、夹紧和刀具通道必须同时确认。'
    },
    {
      id: 'stage-7', title: '刀具基础', file: 'course-tool-basics.html',
      image: './assets/images/batch04_milling_tooling/tool-selection-beginner-001.webp',
      alt: '立铣刀、球头刀和常见铣削刀具选用演示图',
      caption: '根据加工特征认识刀具类型和基本用途。'
    },
    {
      id: 'stage-8', title: '对刀与刀长补偿', file: 'course-tool-length-offset.html',
      image: './assets/images/batch04_milling_tooling/bt-er-holder-overview-001.webp',
      alt: 'BT刀柄、ER夹头、刀具伸出量和刀长关系演示图',
      caption: '把实物刀具、刀柄、H号和程序调用连成一条链。'
    },
    {
      id: 'stage-9', title: 'G00 与 G01', file: 'course-g00-g01-basics.html',
      image: './assets/images/batch02_operation_basics/single-block-dry-run-001.webp',
      alt: '单段、空运行和低倍率验证 G00 G01 程序的演示图',
      caption: '快速定位与直线切削必须先用单段、空运行和低倍率验证。'
    },
    {
      id: 'stage-10', title: 'G02 与 G03', file: 'course-g02-g03-basics.html',
      image: './assets/images/batch04_milling_tooling/milling-contour-001.webp',
      alt: '轮廓圆弧切入切出和圆弧方向演示图',
      caption: '结合加工平面、圆弧方向和切向进退刀理解圆弧编程。'
    },
    {
      id: 'stage-11', title: '孔加工循环', file: 'course-hole-cycles.html',
      image: './assets/images/batch02_operation_basics/canned-cycle-overview-001.webp',
      alt: '钻孔固定循环快速定位、进给、孔底动作和退刀演示图',
      caption: '分清 R 平面、孔深、孔底动作和返回方式。'
    },
    {
      id: 'stage-12', title: '完整程序与首件验证', file: 'course-complete-program-first-piece.html',
      image: './assets/images/batch05_alarm_drawing_material/first-piece-inspection-001.webp',
      alt: '完整程序试切后进行首件尺寸检测和记录的演示图',
      caption: '程序、装夹、空运行、试切和首件测量必须形成闭环。'
    }
  ];
  ...
  function syncLearningContent() {
    ...
    document.dispatchEvent(new CustomEvent('cnc:learning-images-ready', {
      detail: { build: BUILD, count: COURSES.length }
    }));
  }
