window.CNC_GM_CODES = [
  ...
  },
  {
    ...
    "summary": "加工中心/旧系统可用于坐标设定，车床常用于简单螺纹循环。",
    "usage": "车床加工简单螺纹，或旧程序临时设定坐标时使用。",
    "beginner": "G92在不同机型上含义差异很大。",
    "warning": "坐标设定会影响后续位置，螺纹循环则关系主轴同步，必须分清。",
    "example": "车床：G92 X20. Z-30. F1.5 表示螺纹循环。",
    "risk": "高",
    "tags": [
      "G92",
      "坐标设定",
  ...
  },
  {
    ...
    "summary": "加工中心常用G94表示每分钟进给；FANUC车床中也可能表示端面切削循环。",
    "usage": "铣削用mm/min进给，或车床端面固定循环时使用。",
    "beginner": "看机型，铣床G94和车床G94不是一回事。",
    "warning": "车床G94/G95进给单位切换错误会造成进给过快或过慢。",
    "example": "铣床：G94 F200.；车床：G94 X20. Z-2. F0.2。",
    "risk": "高",
    "tags": [
      "G94",
      "每分钟进给",
  ...
  },
  {
    "id": "kb-gcode-g98",
    "category": "G代码",
    "title": "G98 固定循环返回初始点/每分钟进给",
    "code": "G98",
    "aliases": [
      "返回初始平面",
      "Initial point return"
    ],
    "summary": "加工中心固定循环中G98表示每孔后返回初始点；车床中常表示每分钟进给。",
    "usage": "孔加工跨夹具或凸台时用G98抬高返回更安全。",
    "beginner": "钻孔循环里G98比G99退得更高。",
    "warning": "车铣含义不同，且G98会增加空行程时间。",
    "example": "G98 G81 X0 Y0 Z-10. R2. F100. 表示每孔后回初始点。",
    "risk": "高",
    "tags": [
      "G98",
      "固定循环",
  ...
  },
  {
    "id": "kb-gcode-g99",
    "category": "G代码",
    "title": "G99 固定循环返回R点/每转进给",
    "code": "G99",
    "aliases": [
      "返回R平面",
      "R point return"
    ],
    "summary": "加工中心固定循环中G99表示每孔后返回R点；车床中常表示每转进给。",
    "usage": "连续钻同一平面孔阵列时提高效率。",
    "beginner": "G99效率高，但要求R平面绝对安全。",
    "warning": "R点低于夹具或工件凸台时，孔间移动会撞。",
    "example": "G99 G81 X0 Y0 Z-10. R2. F100. 表示每孔后回R2平面。",
    "risk": "高",
    "tags": [
      "G99",
      "固定循环",
