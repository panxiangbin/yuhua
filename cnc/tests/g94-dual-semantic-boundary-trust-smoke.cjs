...
if (!swText.includes("const BUILD = '20260817-pwa51'")) errors.push('Service Worker未升级到20260817-pwa51');
if (!swText.includes("const CACHE_REVISION = '20260817-learning51'")) errors.push('Service Worker缓存修订未升级到20260817-learning51');
if (buildInfo.pwaBuild !== '20260817-pwa51' || buildInfo.cacheRevision !== '20260817-learning51') {
