...
if (!swText.includes("const BUILD = '20260817-pwa48'")) errors.push('Service Worker未升级到20260817-pwa48');
if (!swText.includes("const CACHE_REVISION = '20260817-learning48'")) errors.push('Service Worker缓存修订未升级到20260817-learning48');
if (buildInfo.pwaBuild !== '20260817-pwa48' || buildInfo.cacheRevision !== '20260817-learning48') {
