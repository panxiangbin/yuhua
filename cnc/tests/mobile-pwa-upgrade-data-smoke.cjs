...
const CURRENT_PWA_BUILD = '20260808-pwa21';
const PREVIOUS_PWA_BUILD = '20260808-pwa20';
const CURRENT_CACHE_REVISION = '20260808-learning21';
const PREVIOUS_CACHE_REVISION = '20260808-learning20';
    ...
    await page.evaluate(async ({ previousStatic, previousRuntime, currentStatic, currentRuntime, unrelated }) => {
      ...
      await new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
          ...
          transaction.objectStore('records').put({ xp: 680, streak: 12, source: 'pwa20' }, 'growth');
