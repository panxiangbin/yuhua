...
const PWA_BUILD = '20260815-pwa46';
const CACHE_REVISION = '20260815-learning46';
const GUARD_VERSION = 'g10-g28-g50-g51-g53-g92-g93-g94-g95-g96-g97-g98-g99-boundary-11';
...
(async () => {
  ...
  try {
    ...
    console.log('CNC G95真实断源冷离线可信度门禁通过：PWA38首次安装后关闭本地HTTP源站并进入离线模式，G95双语义安全源仍从静态缓存读取；冷离线重载继续保留车铣差异、当前CNC、G代码组别、原厂手册、单位制、F地址单位与同步攻丝边界，固定参数不得直接照抄上机。');
  } catch (error) {
