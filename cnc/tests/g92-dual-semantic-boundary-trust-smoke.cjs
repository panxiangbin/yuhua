...
if (!guard || guard.version !== 'g10-g28-g53-g92-g93-g94-g95-g96-g97-g98-g99-boundary-9' || typeof guard.normalizeG92 !== 'function') {
  errors.push('G10/G28/G53/G92/G93/G94内容安全归一化器未安装、版本异常或缺少normalizeG92');
}
...
console.log('CNC G92车铣双语义可信度门禁通过：铣削坐标偏移/设定语义与车床螺纹循环语义被明确分开，地址、模态状态、清除方式、主轴同步与安全退刀空间必须按当前CNC和机床厂原厂手册核对；G/M离线核心已正规升级到PWA36。');
