...
const expectedPwaBuild = '20260806-pwa16';
...
const cacheRevisionByBuild = {
  [expectedPwaBuild]: '20260806-learning16',
...
const PREVIOUS_PUBLIC_CORE_PATHS = EXACT_CORE.filter(path => path !== './learning-sublesson-specificity.js');
