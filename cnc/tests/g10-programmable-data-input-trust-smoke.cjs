...
if (!guard || guard.version !== 'g10-g28-g53-g92-g94-g95-g96-g97-g98-g99-boundary-8' || typeof guard.normalizeG10 !== 'function') {
  errors.push('G10/G28/G53/G92/G94/G95/G96/G97/G98/G99内容安全归一化器未安装、版本异常或缺少normalizeG10');
}
...
console.log('CNC G10可编程数据写入可信度门禁通过：基础源目录与运行时条目都把G10限定为控制器相关的高风险数据写入，真实机床必须核对原厂手册、备份并由授权人员确认；G/M可信目录在PWA35首次安装离线核心中继续受保护。');
