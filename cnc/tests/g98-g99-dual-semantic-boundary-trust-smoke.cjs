...
console.log('CNC G98/G99车铣双语义可信度门禁通过：铣削固定循环返回初始平面/R平面与车床每分钟/每转进给被明确分开，不再使用“G98一定更高、G99一定更低或绝对安全”的通用口诀；真实机床须核对当前CNC和机床厂原厂手册并做受控验证；PWA37首次安装离线核心继续受包含G51的boundary-11保护。');
