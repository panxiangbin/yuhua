# Gemini 一次性生成 96 张教学图总指令

把下面整段话直接复制给 Gemini：

```text
你现在是“数控新手学习助手”项目的教学配图设计师。现在请你一次性继续生成后续 96 张数控教学插图，也就是第二批到第五批全部一起完成。
...
1. 每张图单独输出。
2. 文件名必须严格按我给出的文件名保存。
3. 所有图片完成后，按文件名顺序给我完整清单。
4. 如果一次性输出受限，不要改风格，不要改文件名，不要漏图，按当前顺序自动继续后面的图片，直到 96 张全部完成。
...
四、第三批：车床工艺与典型零件 24 张
保存目录：
F:\AI工作台\cnc_param_quickfinder\assets\images\batch03_turning_process\

25. turning-facing-001.webp
主题：端面车削图
要求：画出端面加工走刀方向、切削区域、尺寸控制重点。

26. turning-od-roughing-001.webp
主题：外圆粗车图
要求：画出粗车余量、走刀层次、切削方向。

27. turning-od-finishing-001.webp
主题：外圆精车图
要求：强调表面质量、余量小、刀尖位置稳定。

28. turning-step-shaft-001.webp
主题：阶梯轴加工图
要求：画出多直径台阶轴的典型加工顺序。

29. turning-chamfer-001.webp
主题：倒角加工图
要求：画出 45 度倒角的刀路和尺寸理解方式。

30. turning-fillet-001.webp
主题：圆角过渡图
要求：画出圆角半径与刀路关系。

31. turning-grooving-001.webp
主题：切槽加工图
要求：画出槽宽、槽深、刀具宽度和分层切槽思路。

32. turning-parting-off-001.webp
主题：切断加工图
要求：画出切断刀位置、冷却、夹持风险和正确操作。

33. turning-thread-od-001.webp
主题：外螺纹车削图
要求：画出螺纹区域、退刀槽、牙型、螺距标注。

34. turning-thread-id-001.webp
主题：内螺纹车削图
要求：画出内螺纹孔、底孔、退刀空间和刀具运动。

35. turning-boring-001.webp
主题：内孔镗削图
要求：画出内孔、镗刀、悬伸量、振动风险。

36. turning-center-drill-001.webp
主题：中心钻定位图
要求：画出中心钻作用、钻孔起点稳定作用。

37. turning-deep-hole-001.webp
主题：深孔加工图
要求：强调排屑、分层进给、冷却和钻杆风险。

38. turning-thin-wall-001.webp
主题：薄壁件车削图
要求：画出变形风险、余量控制、夹持方式。

39. turning-long-shaft-001.webp
主题：细长轴加工图
要求：画出尾座、跟刀架或支撑点，强调防振。

40. turning-allowance-flow-001.webp
主题：粗加工到精加工余量图
要求：分粗车、半精车、精车三个阶段画余量变化。

41. turning-surface-finish-001.webp
主题：表面粗糙度与车削参数图
要求：讲清进给、刀尖圆弧、精车表面关系。

42. turning-burr-control-001.webp
主题：毛刺控制图
要求：画出毛刺出现位置和减少毛刺的工艺思路。

43. turning-tool-wear-001.webp
主题：车刀磨损阶段图
要求：画出正常磨损、崩刃、烧损、异常磨损。

44. flange-part-process-001.webp
主题：法兰类零件加工流程图
要求：从毛坯到成品，画出典型法兰零件的车削流程。

45. step-shaft-case-001.webp
主题：阶梯轴案例图
要求：以案例方式串起端面、外圆、台阶、倒角。

46. thread-part-case-001.webp
主题：螺纹件案例图
要求：用完整零件案例串起外圆、退刀槽、螺纹。

47. retaining-ring-groove-001.webp
主题：卡簧槽加工图
要求：画出卡簧槽位置、尺寸、槽刀关系。

48. lathe-process-overview-001.webp
主题：车床常见工艺总览图
要求：把端面、外圆、切槽、螺纹、切断做成工艺总览入口图。

五、第四批：铣床工艺、刀具与装夹 24 张
保存目录：
F:\AI工作台\cnc_param_quickfinder\assets\images\batch04_milling_tooling\

49. milling-face-milling-001.webp
主题：平面铣削图
要求：画出面铣刀走刀方向、覆盖范围、刀纹方向。

50. milling-side-milling-001.webp
主题：侧面铣削图
要求：画出刀具与侧壁接触关系。

51. milling-slot-001.webp
主题：开槽加工图
要求：画出槽宽、刀径、下刀方式和排屑。

52. milling-pocket-001.webp
主题：型腔加工图
要求：画出粗加工型腔和清角区域。

53. milling-contour-001.webp
主题：外轮廓铣削图
要求：画出轮廓路径、让刀位置、进退刀点。

54. milling-helical-entry-001.webp
主题：螺旋下刀图
要求：画出螺旋下刀路径，强调比直插更稳。

55. milling-stepdown-stepover-001.webp
主题：步深与步距图
要求：解释轴向吃刀和径向吃刀区别。

56. milling-rough-vs-finish-001.webp
主题：粗加工与精加工图
要求：双栏对比粗加工和精加工刀路差异。

57. milling-corner-cleanup-001.webp
主题：清角加工图
要求：画出大刀粗加工后小刀清角区域。

58. milling-drill-ream-tap-001.webp
主题：钻孔铰孔攻丝流程图
要求：画出钻孔、铰孔、攻丝的先后流程。

59. vise-clamping-basic-001.webp
主题：平口钳装夹基础图
要求：画出垫块、平行块、基准边、夹紧方向。

60. fixture-plate-datum-001.webp
主题：治具板与基准设定图
要求：画出定位销、压板、基准边、零点设定。

61. soft-jaw-clamping-001.webp
主题：软爪装夹图
要求：画出软爪包络工件的特点和用途。

62. bt-er-holder-overview-001.webp
主题：BT 刀柄与 ER 夹头总览图
要求：画出主流刀柄系统结构和用途差异。

63. endmill-2f-vs-4f-001.webp
主题：两刃刀与四刃刀对比图
要求：说明排屑能力、适用材料和使用场景。

64. ballnose-vs-flat-endmill-001.webp
主题：球刀与平刀对比图
要求：说明平面、侧壁、曲面加工适用差异。

65. drill-types-overview-001.webp
主题：钻头类型总览图
要求：画出中心钻、麻花钻、阶梯钻等基础区别。

66. tap-types-overview-001.webp
主题：丝锥类型总览图
要求：画出直槽丝锥、螺旋丝锥、挤压丝锥的区别。

67. insert-shape-overview-001.webp
主题：刀片形状识别图
要求：画出常见车刀片形状，适合新手识别。

68. tool-holder-reach-rigidity-001.webp
主题：悬伸量与刚性图
要求：对比短悬伸和长悬伸，强调振动风险。

69. tool-breakage-warning-001.webp
主题：刀具断裂前征兆图
要求：画出崩刃、烧刀、振纹、异常声音等视觉表达。

70. burr-in-milling-001.webp
主题：铣削毛刺与去毛刺图
要求：画出毛刺出现位置和改善思路。

71. milling-process-overview-001.webp
主题：铣床常见工艺总览图
要求：把平面、槽、型腔、轮廓、钻孔做成入口图卡。

72. tool-selection-beginner-001.webp
主题：新手刀具怎么选图
要求：用入口图形式说明平刀、球刀、钻头、丝锥、面铣刀的基本选择逻辑。

六、第五批：报警、图纸、量具、材料、案例 24 张
保存目录：
F:\AI工作台\cnc_param_quickfinder\assets\images\batch05_alarm_drawing_material\

73. atc-alarm-flow-001.webp
主题：换刀报警排查图
要求：画出刀库、机械手、刀臂、联锁和排查流程。

74. emergency-stop-chain-001.webp
主题：急停链路图
要求：画出急停按钮、安全门、伺服、主轴、系统之间的链路关系。

75. safety-door-interlock-001.webp
主题：安全门联锁图
要求：说明门没关好时为什么程序不能继续。

76. power-sequence-warning-001.webp
主题：错误上电顺序风险图
要求：做成警示图，说明错误操作可能带来的问题。

77. machine-warmup-flow-001.webp
主题：机床预热流程图
要求：画出冬天或长期停机后预热思路。

78. daily-maintenance-001.webp
主题：每日点检图
要求：画出每天要看的油、气、液、屑、门、夹具、刀具。

79. weekly-maintenance-001.webp
主题：每周保养图
要求：画出过滤、清洁、紧固、润滑、散热检查。

80. ballscrew-guideway-maintenance-001.webp
主题：丝杠导轨保养图
要求：画出丝杠、导轨、润滑点、灰尘积屑影响。

81. coolant-system-overview-001.webp
主题：冷却系统总览图
要求：画出液箱、泵、喷嘴、过滤、回流路径。

82. cabinet-fan-filter-001.webp
主题：电柜风扇与滤网清理图
要求：强调散热不良对系统的影响。

83. grounding-shielding-001.webp
主题：接地与屏蔽基础图
要求：适合新手理解信号线、动力线、屏蔽层和接地关系。

84. battery-loss-parameter-risk-001.webp
主题：电池失效与参数丢失风险图
要求：警示图风格，说明掉电后可能出现的问题。

85. vernier-caliper-detail-001.webp
主题：游标卡尺详细读数图
要求：单独放大游标卡尺结构与读数步骤。

86. micrometer-detail-001.webp
主题：外径千分尺详细读数图
要求：单独画微分筒、套筒刻线、读数示意。

87. dial-indicator-detail-001.webp
主题：百分表详细读数图
要求：单独画大表盘、小表盘、读数方向和测头。

88. bore-gauge-detail-001.webp
主题：内径量表详细使用图
要求：画出找极值、标准环规校正、孔内测量姿态。

89. drawing-fit-h7-h6-001.webp
主题：H7/h6 配合图
要求：画出孔轴公差带位置关系。

90. drawing-gdt-basic-001.webp
主题：形位公差基础图
要求：画出平面度、垂直度、位置度三个最常见符号和示意。

91. drawing-thread-pitch-tapdrill-001.webp
主题：螺距与底孔对照图
要求：适合新手快速判断攻丝底孔尺寸逻辑。

92. material-stainless-cutting-001.webp
主题：不锈钢加工特点图
要求：画出粘刀、发热、毛刺、排屑等特点。

93. material-aluminum-cutting-001.webp
主题：铝件加工特点图
要求：画出高速、轻切削、积屑瘤风险和表面质量特点。

94. material-steel-castiron-001.webp
主题：钢件与铸铁加工对比图
要求：双栏对比钢件和铸铁的切削特性。

95. first-piece-inspection-001.webp
主题：首件检验流程图
要求：画出首件加工后测量、记录、修正、复检的流程。

96. beginner-mistakes-overview-001.webp
主题：新手最常见错误总览图
要求：做成总览入口图，包含坐标系看错、对刀错、单位错、刀补错、报警乱处理等。

七、完成后的回复格式要求
96 张图全部完成后，请按下面格式回复我：
1. 文件名
2. 图片主题
3. 是否已经按指定目录和指定文件名保存
4. 哪几张最适合优先接入网页
